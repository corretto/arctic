...
/**
 * Defines a ResultsKeeper for values of type {@link TestStatusCode}. This will keep the result of replaying the
 * different tests.
 */
public interface ArcticTestResultsKeeper extends ArcticSessionKeeper<TestId, TestStatusCode> {
