...
/**
 * This class transforms Arctic representations of Mouse events to the ones used by jNativeHook, so they can be
 * posted during replay.
 */
public final class ArcticMouseEvent2JnhMouseEvent {

    /**
     * Converts from an Arctic event to a NativeMouseEvent to use with jNativeHook.
     ...
     * @return NativeMouseEvent equivalent to the arctic event.
     */
    public NativeMouseEvent convert(final MouseEvent mouseEvent, final int offsetX, final int offsetY) {
